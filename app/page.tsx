          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-start">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="relative group">
                <div className="aspect-[3/2] bg-gradient-to-br from-green-50 via-emerald-50 to-teal-100 rounded-xl border-2 border-dashed border-green-300 flex items-center justify-center hover:border-green-400 transition-all duration-300 shadow-sm hover:shadow-md">
                  {/* Replace this placeholder with your actual image */}
                  <div className="text-center p-8">
                    <div className="w-20 h-20 bg-gradient-to-br from-green-200 to-emerald-300 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
                      <svg className="w-10 h-10 text-green-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                      </svg>
                    </div>
                    <h4 className="text-green-700 font-bold text-lg mb-2 font-orbitron">Vision Image</h4>
                    <p className="text-green-600 text-sm mb-3">Showcase your agricultural technology</p>
                    <div className="inline-flex items-center px-4 py-2 bg-green-100 rounded-full text-green-700 text-sm font-medium">
                      ...
                      Add Image (Recommended: 1200x800px)
                    </div>
                  </div>
                </div>

                {/* Ready-to-use Image Component - Uncomment when you have an image */}
                {/*
                <div className="aspect-[3/2] rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
                  <Image
                    src="/images/vision-section.jpg"
